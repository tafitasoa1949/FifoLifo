 ...
 */
public class UpdateSortieServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Connection con = null;
            String idsortie = request.getParameter("sortie");
            try {
                con = Connexion.getconnection();
                Sortie sortie = new Sortie().getById(idsortie, con);
                out.print(sortie.getId());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateSortieServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
