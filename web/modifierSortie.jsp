                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Modifer un sortie de produit</h4>
                            </div>
                            <div class="card-block">
                                <div class="card-body">
                                    <form action="<%= request.getContextPath() %>/ChangeSortieServlet">
                                        <input type="hidden" id="idsortie" name="idsortie" value="<%= sortie.getId() %>">
                                        <fieldset class="form-group">
                                            <label for="selectInput">Magasin</label>
                                            <select class="form-control" id="selectInput" name="magasin">
                                                <option value="<%= sortie.getMagasin().getId()%>" selected=""><%= sortie.getMagasin().getNom() %></option>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <select class="form-control" id="selectInput" name="article">
                                                <option value="<%= sortie.getArticle().getId()%>" selected=""><%= sortie.getArticle().getNom() %></option>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="number" step="any" class="form-control" id="basicInput" name="quantite" value="<%= sortie.getQuantite() %>">
                                        </fieldset>
                                        <fieldset class="form-group">
                                            <label for="additionalInput">Date</label>
                                            <input type="datetime-local" class="form-control" id="additionalInput" name="date" value="<%= sortie.getDate()%>">
                                        </fieldset>
