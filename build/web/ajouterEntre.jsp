                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="card-body">
                                    <form action="<%= request.getContextPath() %>/Entre">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="number" step="any" class="form-control" id="basicInput" name="quantite">
                                        </fieldset>
                                        <fieldset class="form-group">
                                            <label for="additionalInput">Prix unitaire</label>
                                            <input type="number" step="any" class="form-control" id="additionalInput" name="prix_unitaire">
                                        </fieldset>
                                        <fieldset class="form-group">
                                            <label for="additionalInput">Date</label>
                                            <input type="datetime-local" class="form-control" id="additionalInput" name="date">
                                        </fieldset>
                                        <fieldset class="form-group">
